...
//  ArcadiaGenesisCore
//
//  Created by Davide Andreoli on 29/07/24.
//

import Foundation
import ArcadiaCore

@Observable public class ArcadiaGenesis: ArcadiaCoreProtocol {
    
    public typealias ArcadiaCoreType = ArcadiaGenesis
